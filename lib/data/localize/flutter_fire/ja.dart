...
class JaLocalizations extends FlutterFireUILocalizationLabels {
  ...
  const JaLocalizations({
    ...
    this.registerActionText = '登録',
    this.signInButtonText = 'サインイン',
    this.registerButtonText = '登録',
    this.linkEmailButtonText = '次へ',
    this.signInWithPhoneButtonText = '電話でサインイン',
    ...
    this.verifyCodeButtonText = '検証',
    this.verifyingPhoneNumberViewTitle = 'SMSからコードを入力してください',
    this.unknownError = '不明なエラーが発生しました',
    this.smsAutoresolutionFailedError =
        'SMSコードを自動的に解決できませんでした。コードを手動で入力してください ',
    this.smsCodeSentText = '送信されたSMSコード',
    this.sendingSMSCodeText = 'SMSコードを送信しています...',
    this.verifyingSMSCodeText = 'SMSコードを確認しています...',
    this.enterSMSCodeText = 'SMSコードを入力してください',
    this.emailIsRequiredErrorText = 'メールが必要です',
    this.isNotAValidEmailErrorText = '有効なメールアドレスを提供してください',
    this.userNotFoundErrorText = "アカウントが存在しません",
    this.emailTakenErrorText = 'そのようなメールのアカウントはすでに存在します',
    this.accessDisabledErrorText = 'このアカウントへのアクセスは一時的に無効になっています',
    this.wrongOrNoPasswordErrorText = 'パスワードが無効であるか,ユーザーがパスワードを持っていません',
    this.signInText = 'サインイン',
    this.registerText = '登録',
    this.registerHintText = "アカウントをお持ちではありませんか？",
    this.signInHintText = 'すでにアカウントをお持ちですか？',
    this.signOutButtonText = 'サインアウト',
    this.phoneInputLabel = '電話番号',
    this.phoneNumberInvalidErrorText = '電話番号が無効です',
    this.phoneNumberIsRequiredErrorText = '電話番号が必要です',
    this.profile = 'プロファイル',
    this.name = '名前',
    this.deleteAccount = 'アカウントの削除',
    this.passwordIsRequiredErrorText = 'パスワードが必要です',
    this.confirmPasswordIsRequiredErrorText = 'パスワードを確認してください',
    this.confirmPasswordDoesNotMatchErrorText = 'パスワードが一致しません',
    this.confirmPasswordInputLabel = 'パスワードの確認',
    this.forgotPasswordButtonLabel = 'パスワードをお忘れですか？',
    this.forgotPasswordViewTitle = 'パスワードを忘れた',
    this.resetPasswordButtonLabel = 'パスワードをリセット',
    this.verifyItsYouText = "Verify it's you",
    this.differentMethodsSignInTitleText = '次のいずれかの方法を使用してサインインします',
    this.findProviderForEmailTitleText = '続行するにはメールアドレスを入力してください',
    this.continueText = '続行',
    this.countryCode = 'コード',
    ...
    this.passwordResetEmailSentText =
        'パスワードをリセットするためのリンクが記載されたメールを送信しました。メールを確認してください。',
    this.forgotPasswordHintText = 'メールアドレスを入力してください。パスワードをリセットするためのリンクをお送りします',
    ...
    this.stringLabel = '文字列',
    this.typeLabel = 'type',
    this.valueLabel = 'value',
    this.cancelLabel = 'キャンセル',
    this.updateLabel = 'アップデート',
    this.northInitialLabel = '北',
    this.southInitialLabel = '南',
    this.westInitialLabel = '西',
    this.eastInitialLabel = '東',
    this.timestampLabel = 'タイムスタンプ',
    this.longitudeLabel = '経度',
    this.latitudeLabel = '緯度',
    this.geopointLabel = '位置情報',
    this.referenceLabel = '参照',
  });
}

class DefaultLocalizations extends JaLocalizations {
